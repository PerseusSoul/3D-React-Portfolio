      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I&apos;m <span className="text-[#0CAFFF]">Carlos</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop stunning Web and Mobile applications
          </p>
          <p className={`${styles.heroSubTextDesc} mt-2 text-white-100`}>
            Specialize in various languages and frameworks with 7 years of experience
          </p>
